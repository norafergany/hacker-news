...
jest.describe('useGetStories', () => {
    jest.it('fetches successfully data from an API', async () => {
        const data = {ids};
        axios.get.mockImplementationOnce(() => Promise.resolve(data));
        await jest.expect(useGetStories(ids)).resolves.toEqual(stories);
    })
})

// const useGetStoriesTest = (urlParams) => {
//     const stories = [
//         {
//             "by": "jmillikin",
//             "descendants": 4,
...
//     jest.mock('axios');
//
//     describe('fetch stories', () => {
//         describe('fetch successful', () => {
//             it('should return ', async () => {
//                 const mockedStories = {stories}
//
//                 axios.get.mockResolvedValueOnce(mockedStories)
//
//             })
//         })
//     });
...
export default useGetStoriesTest;
// test('fetch stories', () => {
//     const resp = {data: stories};
//     const params = 'topstories';
//     axios.get.mockResolvedValue(resp);
//
//     return useGetStories(params).then(data => expect(data).toEqual((stories)));
// })

// Things to test
// - the ids returned from the first id call are present in the second id call

// const getStories = (urlParams) => {
//     return new Proms
// }